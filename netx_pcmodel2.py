...
def consecutive_vals(y:list, num_nans_cutoff:int, consec_val:float)->int:
    counts = 0
    consec_counts = 0
...
def network_append(s1name:str, s1:np.array, s2name:str, s2:np.array, times:list, window_mod:list, cutoffh:float, gapfinder:float) ->None:
